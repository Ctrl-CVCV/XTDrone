#!/usr/bin/env bash
# =============================================================================
# 一体化任务单门入侵演示脚本：右门（RIGHT）
#
# 用法（宿主终端，一条命令）:
#   docker exec -it xtdrone-dev bash /workspace/mission_demo_right.sh
#
# 功能:
#   1. 清理残留仿真 -> 启动 multi_car3_mission.launch（GUI 直连宿主 X :1）
#   2. 入侵车固定从右门入侵（entry_mode=fixed, entry_gate=RIGHT）
...
#   docker exec xtdrone-dev bash /workspace/mission_demo_right.sh false
# =============================================================================
...
LOG=/tmp/mission_demo_right.log
GUI=${1:-true}
